...
import ReviewInbox from "./Components/sections/ReviewInbox";

function App() {
  return (
    <div className="App cp-root">
      <FontLoader />
      <a href="#inbox" style={{ display: "block", padding: "10px 32px", background: "#1b3a2b", color: "white", textAlign: "center" }}>Open your Google review desk →</a>
